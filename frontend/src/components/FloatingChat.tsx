    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          id="ask-fynq-button"
          aria-label="Ask AI"
          className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[999999] w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 text-white shadow-[0_4px_20px_rgba(59,130,246,0.4)] hover:shadow-[0_8px_30px_rgba(59,130,246,0.6)] flex items-center justify-center transition-all duration-300 hover:scale-105 active:scale-95"
        >
